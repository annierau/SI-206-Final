...
plt.title("How Temperature and Nasdaq Stock Price Are Related", loc='center', fontweight='bold')
plt.xlabel("Temperature (Celsius)")
plt.ylabel("Nasdaq Price Change %")
plt.show()
...
plt.title("How Types of Weather and Stock Price Are Related", loc='center', fontweight='bold')
plt.xticks(rotation = 45)
plt.xlabel("Type of Weather")
plt.ylabel("Nasdaq Stock Price Change %")
plt.show()
